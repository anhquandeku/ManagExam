 ...
 * @author ASUS
 */
public class PanelQuanLyNhanVien {
    ...
    NhanVienDTO nvhoantac;

    public PanelQuanLyNhanVien(String pnCenter) {
        ...
        info = temp;
        MyLabel lbMaNV = new MyLabel("Mã nhân viên :");
        lbMaNV.setPreferredSize(new Dimension(120, 30));
        top.add(lbMaNV);
                ...
                if (txtHo.getText().equals("") || txtTen.getText().equals("") || cbNam.getSelectedItem().equals("YYYY") || cbThang.getSelectedItem().equals("MM") || cbNgay.getSelectedItem().equals("DD") || cbKhoa.getSelectedItem().equals("") || cbGioiTinh.getSelectedItem().equals("")) {
                    ...
                    err.btnOK.addMouseListener(new MouseAdapter() {
                        public void mouseClicked(MouseEvent arg0) {
                            ...
                            NhanVienDTO dtNV = new NhanVienDTO();
                            dtNV.setMaKhoa(maKhoa);
                            dtNV.setHoDem(txtHo.getText());
                            dtNV.setTen(txtTen.getText());
                            dtNV.setNgaySinh(ngaySinh);
                            dtNV.setGioiTinh(cbGioiTinh.getSelectedItem().toString());
                            nv.them(dtNV);
                    ...
                    if (txtHo.getText().equals("") || txtTen.getText().equals("") || cbNam.getSelectedItem().equals("YYYY") || cbThang.getSelectedItem().equals("MM") || cbNgay.getSelectedItem().equals("DD") || cbKhoa.getSelectedItem().equals("") || cbGioiTinh.getSelectedItem().equals("")) {
                        ...
                        err.btnOK.addMouseListener(new MouseAdapter() {
                            public void mouseClicked(MouseEvent arg0) {
                                ...
                                dtNV.setNgaySinh(ngaySinh);
                                dtNV.setGioiTinh(cbGioiTinh.getSelectedItem().toString());
                                nvhoantac = nv.getObject(String.valueOf(model.getValueAt(i, 1)));
                                nv.sua(dtNV, String.valueOf(model.getValueAt(i, 1)));
        ...
        bts[3].addMouseListener(new MouseAdapter() {
            public void mouseClicked(MouseEvent arg0) {
                if (check == 1) {
                    nv.khoiphuc(mahoantac);
                } else if (check == 2) {
                    nv.xoavinhvien(mahoantac);
                } else if (check == 3) {
                    nv.sua(nvhoantac, mahoantac);
                } else if (check == 4) {
                    for (int i = 0; i < checkbox.size(); i++) {
                        nv.khoiphuc(checkbox.get(i));
                    }
                }

                vtData.clear();
                vtData.addAll(nv.getThongTin(Integer.parseInt(txtPage.getText())));
                model.setDataVector(vtData, vtHeader);
                tba.setModel(model);
                guiBase.isEnabled(bts[3]);
                check = 0;
        ...
        btImportExcel.addMouseListener(new MouseAdapter() {
            public void mouseClicked(MouseEvent arg0) {
                nv.importExcel(file.getFileExcelNameOpen(pnPaint));
            }
        });

        btExportExcel.addMouseListener(new MouseAdapter() {
            public void mouseClicked(MouseEvent arg0) {
                nv.exportExcel(file.getFileExcelNameSave(pnPaint));
            }
        });
        //Tính số trang
        if (cout % 25 == 0) {
