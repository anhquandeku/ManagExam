...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th5 15, 2021 lúc 01:08 PM
...
('SV001', 'D006', 'BCDCDBDDDDCDCDDDDDDDCBCBDDDADBDBCDA', '00010010000100000101000100000000001', 7, '2.0', 1),
...
--
-- Đang đổ dữ liệu cho bảng `baithi_kythi`
--

INSERT INTO `baithi_kythi` (`MaSV`, `MaDe`, `DSCauTraLoi`, `DanhSachDungSai`, `SoCauDung`, `MaKyThi`, `Diem`, `TrangThai`) VALUES
('SV003', 'D001', '', '', 0, 'KT01', '8', 1);
...
CREATE TABLE `dethi` (
  ...
  `De` int(2) NOT NULL DEFAULT 3,
  `TrungBinh` int(2) NOT NULL,
  `Kho` int(2) NOT NULL DEFAULT 2,
  `TrangThai` int(1) NOT NULL DEFAULT 1
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `dethi` (`MaDe`, `MaMon`, `MaKyThi`, `ThoiGianLamBai`, `NgayThi`, `GioThi`, `SoLuongCauHoi`, `De`, `TrungBinh`, `Kho`, `TrangThai`) VALUES
('D001', 'MH003', 'KT01', 45, '2021-02-20', '09:45:00', 10, 3, 5, 2, 1),
('D002', 'MH001', 'KT01', 5, '2021-02-18', '10:09:00', 10, 3, 5, 2, 1),
('D003', 'MH023', 'KT01', 12, '2021-02-16', '10:10:00', 20, 3, 5, 2, 1),
('D004', 'MH001', 'KT02', 20, '2021-05-12', '18:30:00', 10, 3, 15, 2, 1),
('D005', 'MH002', 'KT02', 30, '2021-06-10', '20:15:00', 10, 3, 5, 2, 1),
('D006', 'MH023', 'KT02', 10, '2021-05-12', '20:22:01', 35, 12, 17, 6, 1),
('D007', 'MH001', 'KT02', 60, '2021-05-12', '22:40:00', 10, 3, 5, 2, 1),
('D008', 'MH001', 'KT02', 20, '2021-05-15', '18:30:00', 10, 3, 7, 0, 1);
...
('KT01', 'Kết Thúc Học Phần Học Kì I năm học 2020-2021', '2021-02-15', '2021-02-26', 1),
...
('L003', 'K001', 'GV001', 'Lớp Toán', 1),
('L004', 'K015', 'GV003', 'Lớp vệ sinh', 1),
('L005', 'K016', 'GV005', 'Lớp Chính trị', 1);
...
ALTER TABLE `baithi_kythi`
  ADD PRIMARY KEY (`MaSV`,`MaDe`),
  ADD KEY `MaDe` (`MaDe`),
  ADD KEY `baithi_kythi_ibfk_3` (`MaKyThi`);
...
ALTER TABLE `baithi_kythi`
  ...
  ADD CONSTRAINT `baithi_kythi_ibfk_3` FOREIGN KEY (`MaKyThi`) REFERENCES `kythi` (`MaKyThi`);
